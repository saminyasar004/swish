				...
				<div className="w-full grid grid-cols-3 gap-5 items-center">
					<div className="w-full flex flex-col gap-4">
						...
						<p className="text-base text-[##404C67]">
							Tell us what you need help with, and we will send
							out the project to relevant companies.
						</p>
					</div>
					...
					<div className="w-full flex flex-col gap-4">
						...
						<p className="text-base text-[##404C67]">
							After a short time, you will receive non-binding
							offers from companies and professionals who will
							help you.
						</p>
					</div>
					...
					<div className="w-full flex flex-col gap-4">
						...
						<p className="text-base text-[##404C67]">
							The right company for the job. When the job is done,
							you can post an evaluation.
						</p>
					</div>
				</div>
