      ...
      <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-6">
          ...
          <div className="flex items-start gap-4">
            <img
              src={pencilIcon}
              alt="Access to jobs icon"
              className="w-6 h-6 mt-1"
            />
            <div>
              <h3 className="font-semibold text-primaryDark mb-4">
                Access to jobs
              </h3>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Your business will be visible in search, and customers can get
                in touch directly through your profile page.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            <img
              src={chatIcon}
              alt="Showcase company icon"
              className="w-6 h-6 mt-1"
            />
            <div>
              <h3 className="font-semibold text-primaryDark mb-4">
                We showcase your company
              </h3>
              <p className="text-sm text-gray-600">
                With the Profile Page and homepage on swish.ma, you can showcase
                your logo, employees, photos and more. It’s easy to make a great
                first impression.
              </p>
            </div>
          </div>
