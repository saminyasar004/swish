...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-normal ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default: "bg-providerPrimary text-white hover:bg-providerPrimary/80",
        transparent:
          "bg-transparent border border-slate-200 text-black hover:bg-slate-100 hover:text-slate-500",
        destructive:
...
const ButtonProvider = React.forwardRef<HTMLButtonElement, ButtonProps>(
...
export { ButtonProvider, buttonVariants };
