...
function NavigationMenuSheetContent() {
	const categories: CategoryProps[] = [
		...
		},
		{
			...
			subcategories: [
				...
				{
					name: "Windows & Doors",
					url: "/exterior-garden/windows-doors",
				},
				{
					name: "Terrace Shade",
		...
		},
		{
			...
			subcategories: [
				...
				{
					name: "Full Kitchen/Bathroom/Basement/Living Room/Staircase/Laundry Renovations",
	...
	return (
		<div className="w-full h-screen min-w-max flex gap-2 relative overflow-hidden">
			<div
				className={cn(
					...
					<div className="w-full flex flex-col gap-1">
						{categories.map((category, index) => (
							<Button
								key={index}
								variant="link"
								className="w-full flex items-center justify-between font-medium text-sm transition-all duration-300 cursor-pointer hover:bg-slate-100 py-3 px-2 rounded-md hover:no-underline"
					...
					{currentCategory && (
						<div className="flex flex-col gap-1">
							<Link
								...
								className="w-full flex items-center justify-between font-semibold text-xl transition-all duration-300 cursor-pointer hover:bg-slate-100 py-3 px-2 rounded-md"
							>
						...
						{categories[0].subcategories.map(
							(subCategoryItem, index) => (
								<Link
									...
									className="w-full font-medium text-sm transition-all duration-300 cursor-pointer hover:bg-slate-100 py-3 px-2 rounded-md"
									onClick={() =>
