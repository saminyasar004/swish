...
const UploadIllustration = () => (
    <div className="relative w-16 h-16">
        ...
        >
            ...
            <path
                d="M30 35H70C75 35 75 40 40V65C75 70 70H30C25 25 65 65V40C25 30 35Z"
            ...
            >
                <animate
                    ...
                    dur="2s"
                    repeatCount="indefinite"
                    values="M30 35H70C75 35 75 40 40V65C75 70 70H30C25 25 65 65V40C25 30 35Z;
                     38H70C75 38 43 43V68C75 73 73H30C25 68 68V43C25 38Z;
                     35Z"
                />
            </path>

            <path
                d="M30 35C30 35 40 35C45 45 30 50 30C55 55 60 35C65 70"
            ...
            <g className="transform translate-y-2">
                ...
                >
                    <animate
                        ...
                        values="42,52 50,45 58,52;42,47 50,40 58,47;42,52 58,52"
                        dur="2s"
                        repeatCount="indefinite"
                    />
                </polyline>
